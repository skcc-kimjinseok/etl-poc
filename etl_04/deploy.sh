...
IMAGE_NAME="etl-02-pipeline" # Docker image name
...
DEPLOYMENT_NAME="etl-04-pipeline" # Kubernetes deployment name
SECRET_NAME="etl-04-secret"
...
kubectl create secret generic $SECRET_NAME --from-literal=db-password=$DB_PASSWORD --from-literal=az-account-key=$AZ_ACCOUNT_KEY --namespace=$NAMESPACE
